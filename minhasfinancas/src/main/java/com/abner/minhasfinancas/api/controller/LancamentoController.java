...
import com.abner.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.abner.minhasfinancas.api.dto.LancamentoDTO;
...
import com.abner.minhasfinancas.model.enums.TipoLancamento;
...
public class LancamentoController {
		...
		return service.obterPorId(id).map(entity -> {
			...
			if (statusSelecionado == null) {
				return ResponseEntity.badRequest()
						.body("Não foi possivel atualizar o stats do lancamento, envie um status valido.");
			}
	...
	private LancamentoDTO converter(Lancamento lancamento) {
		LancamentoDTO dto = new LancamentoDTO(lancamento.getId(), lancamento.getDescricao(), lancamento.getMes(),
				lancamento.getAno(), lancamento.getUsuario().getId(), lancamento.getValor(),
				lancamento.getTipo().name(), lancamento.getStatus().name());
